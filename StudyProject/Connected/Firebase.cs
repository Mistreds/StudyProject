...
namespace StudyProject
{
    public class Firebase
    {
        ...
        public Firebase()
        {
            string path = AppDomain.CurrentDomain.BaseDirectory + @"test-66d74-firebase-adminsdk-jz0nu-f863f22421.json";
            Environment.SetEnvironmentVariable("GOOGLE_APPLICATION_CREDENTIALS", path);
            db = FirestoreDb.Create("test-66d74");
        }
        public static void UploadPictires(Model.Pictures pictures)
        {
        ...
        private async Task DownPicAsync(int IdGood)
        {
        ...
        public Pictures DownloadPictires(int IdGood)
        {
